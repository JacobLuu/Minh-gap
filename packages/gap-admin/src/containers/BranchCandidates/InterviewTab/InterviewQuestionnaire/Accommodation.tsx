          ...
          <Box px={5}>
            ...
            >
              <Typography my={2} variant="optionText">
                Are you free to travel to and from work using the transport
            ...
            >
              <Typography my={2} variant="optionText">
                Do you rent your accommodation from anyone who works for, or is
                linked to gap personnel, or our clients?
              </Typography>
              <Typography my={2} variant="body2">
